...
// ================================================= //
//  GLOBAL VARIABLES: REGISTER USER
// ================================================= //
...
// ================================================= //
//  BUTTON EVENT: REGISTER NEW USER TO LOBBY
// ================================================= //
...
chatRef.on('child_added', function(childSnapshot) {
    ...
    $chatUi.append("<li class='msg-entry'>" + userName + ": " + message + "</li>");
...
// ================================================= //
//  GLOBAL VARIABLES: RPS GAME FUNCTIONS
// ================================================= //
...
// ================================================= //
//  DATABASE LISTENER: PLAYER ONE/TWO READY 
// ================================================= //
...
database.ref("/turn/").on("value", function(snapshot) {
	...
	if (snapshot.val() === 1) {
        ...
        $(".pl-one-final").html("<img class='img-result' src='assets/images/" + plOne.choice + ".png' alt='"  + plOne.choice +  "'>");
        $(".pl-two-final").html("<img class='img-result' src='assets/images/" + plTwo.choice + ".png' alt='"  + plTwo.choice +  "'>");
...
$(".pl-one-choice").click(function(event) {
	...
	if (plOne && plTwo && (userName === plOne.name) && (turn === 1) ) {
        ...
        // Attatch choice pic of player into result display
